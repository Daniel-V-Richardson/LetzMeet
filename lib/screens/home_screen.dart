...
import 'package:letzmeet/screens/meeting_screen.dart';
import 'package:letzmeet/utils/colors.dart';
import 'package:letzmeet/widgets/custom_button.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<Widget> pages = [
    ...
    const Text('Contact'),
    PrimaryButton(text: 'Logout', onPressed: () => AuthMethods().signOut()),
  ];
